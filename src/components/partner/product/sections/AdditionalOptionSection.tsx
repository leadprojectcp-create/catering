...
import styles from './AdditionalOptionSection.module.css'

interface AdditionalOptionSectionProps {
...
export default function AdditionalOptionSection({ options, onChange, onShowHelpModal, enabled, onToggle }: AdditionalOptionSectionProps) {
