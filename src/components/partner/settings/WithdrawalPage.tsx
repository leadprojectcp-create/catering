        ...
        <div className={styles.noticeList}>
          <div className={styles.noticeItem}>
            <div className={styles.noticeContent}>
              <h3 className={styles.noticeItemTitle}>1. 정산 예정 금액이 있는지 확인해 주세요</h3>
              <p className={styles.noticeText}>
                탈퇴 시, 아직 정산되지 않은 금액이 있다면 정산 처리 후 탈퇴 가능하며,
                정산 주기 및 지급 일정에 따라 금액이 지급된 이후 탈퇴 요청이 완료됩니다.
              </p>
            </div>
          </div>
          ...
          <div className={styles.noticeItem}>
            <div className={styles.noticeContent}>
              <h3 className={styles.noticeItemTitle}>3. 탈퇴 시 상품 정보 및 판매 이력이 모두 삭제됩니다</h3>
              <p className={styles.noticeText}>
                등록된 상품, 리뷰, 정산 내역 등 파트너 페이지의 모든 정보가 삭제되며,
          ...
          <div className={styles.noticeItem}>
            <div className={styles.noticeContent}>
              <h3 className={styles.noticeItemTitle}>4. 동일 사업체로 재가입 시 별도 절차가 필요할 수 있습니다</h3>
              <p className={styles.noticeText}>
                탈퇴 후 같은 정보로 재입점하려면 운영팀의 확인 절차가 진행됩니다.
              </p>
            </div>
          </div>
        </div>
