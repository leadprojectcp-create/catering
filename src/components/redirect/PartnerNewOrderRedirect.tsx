...
export default function PartnerNewOrderRedirect() {
  ...
  useEffect(() => {
    ...
    // 앱 스킴 URL - 파트너 신규주문은 주문 목록으로
    const appScheme = `danmo:///partner/order/history`

    console.log('[Partner New Order Redirect] Redirecting to:', appScheme)
    ...
    const timer = setTimeout(() => {
      console.log('[Partner New Order Redirect] App not opened, showing download page')
      setShowDownload(true)
    }, 2500)
